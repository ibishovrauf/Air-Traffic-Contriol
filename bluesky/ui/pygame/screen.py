...
class Screen:
    ...
    def init(self):
        ...
        lst = np.genfromtxt("bluesky/resources/data/graphics/scr_cfg.dat", comments='#', dtype='i4')
        ...
        self.acsymbol = []
        for i in range(60):
            self.acsymbol.append(pg.image.load("bluesky/resources/data/graphics/acsymbol/acsymbol" \
                                  + str(i) + ".png"))

        self.ambacsymbol = []
        for i in range(60):
            self.ambacsymbol.append(pg.image.load("bluesky/resources/data/graphics/amb-acsymbol/amb-acsymbol" \
                                     + str(i) + ".png"))
        ...
        wptgif = pg.image.load("bluesky/resources/data/graphics/waypoint.gif")
        ...
        aptgif = pg.image.load("bluesky/resources/data/graphics/airport.gif")
        ...
        #--------------------------------MAPS---------------------------------
        # Read map of world
        self.mapbmp = pg.image.load("bluesky/resources/data/graphics/world.jpg")
        ...
        iconpath = imgpath = "bluesky/resources/data/graphics/icon.gif"
        ...
        f = open("bluesky/resources/data/navdata/coastlines.dat", 'r')
    ...
    def show_cmd_doc(self, cmd=''):
        ...
        curdir = os.getcwd()
        os.chdir("bluesky/resources/data/html")
